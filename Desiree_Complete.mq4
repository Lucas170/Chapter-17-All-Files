...
Warning: If you have not attempted to code Desiree on your own. Stop reading the code and attempt it. 
         Don't waste the learning opportunity. Open Desiree_Incomplete.mq4 to start.
...
// TDL 3: Create/modify extern and internal use variables
...
int start()
  {
      ...
      // TDL 1: Modify Exit and Entry Rules
      ...
      // TDL 4: Manage Stop Loss modifications and position/order termination
