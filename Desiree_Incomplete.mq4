...
Difficulty Level: Hard
      This is the most challenging robot you will attempt so far. 
      The amount you will learn from coding Desiree will be worth while. 
      If you can code this, you can code 90% of all robots out there.

Notes: 
      Desiree_Incomplete is essentially FalconTemplate1-3.mq4
      There are no TDLs to assist you
      2 General Approach
         1) Code according to the rules (Start with entries, then exits and sizing)
         2) Code downwards line by line (Need to be decently experienced to code this way)
